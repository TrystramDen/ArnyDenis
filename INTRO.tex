...
many of the summations we study provides us with many opportunities to
look at numbers and their summations in many quite distinct ways.  For
this reason, this chapter is one of the most important as the reader
progresses with the endeavor of ``doing mathematics''.
...
Chapter~\ref{ch:Recurrences} is devoted to a family of {\em
  computational procedures}, {\it recurrences}.  The patterns that
underlie recurrent computations have been known for millennia to occur
throughout nature---in the growth patterns of many plants, in the
demographics of many animals, among other places.  The mathematics
that describes such computations is as elegant and aesthetic as it is
useful.  Among the myriad recurrent patterns one could identify, we
select three main ones for their computational importance.
\begin{enumerate}
\item
{\it Linear recurrences} are unavoidable when analyzing basic
algorithms.  **HERE
\end{enumerate}
