...
\caption{The summation $S_2(n) = \sum_{i=1}^n i^2$ represented as the aggregate area of a sequence of unit-width shaded rectangles.  The summation is {\em bounded from above} by the area under the continuous curve (a) that connects the upper lefthand corners of the rectangles.  In detail, curve (a) begins at the upper lefthand corner of the leftmost rectangle; it continues to what would be the upper lefthand corner of the $(n+1)$th rectangle.  The area under curve (a) is $\int_0^n \ (x+1)^2 dx$.  The summation is {\em bounded from below} by the area under the continuous curve (b) that connects the upper righthand corners of the rectangles.  In detail, curve (b) begins at the upper righthand corner of the leftmost rectangle; it continues to the upper righthand corner of the $n$th rectangle.  The area under curve (b) is $\int_1^n \ x^2 dx$.}
\label{fig:riemann-n2}
%\label{fig:SumIntegral1}
\end{figure}
Because curve (a) completely ``covers'' the rectangles, the area under curve (a) is an {\em upper bound} on the aggregate area of the rectangles; this area is
\[ \int_1^n \ x^2 dx \]
Because curve (b) lies completely within the area formed by the rectangles, the area under  curve (b) is a {\em lower bound} on the aggregate area of the rectangles; this area is
\[ \int_0^{n-1}  \ x^2 dx \]
...
****************
The summation $S_2(n) = \sum_{i=1}^n i^2$ represented as the aggregate area of a sequence of unit-width shaded rectangles.  The summation is {\em bounded from above} by the area under the continuous curve (a) that connects the upper lefthand corners of the rectangles.  In detail, curve (a) begins at the upper lefthand corner of the leftmost rectangle; it continues to what would be the upper lefthand corner of the $(n+1)$th rectangle.  The area under curve (a) is $\int_0^n \ (x+1)^2 dx$.  The summation is {\em bounded from below} by the area under the continuous curve (b) that connects the upper righthand corners of the rectangles.  In detail, curve (b) begins at the upper righthand corner of the leftmost rectangle; it continues to the upper righthand corner of the $n$th rectangle.  The area under curve (b) is $\int_1^n \ x^2 dx$
}
