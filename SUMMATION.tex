...
%1^3                     & = & 1   & = {\displaystyle \delta_1^2 {2 \choose 2}^2 } \\
%1^3 + 2^3           & = & 9   & = {\displaystyle {3 \choose 2}^2 } \\
\end{array}
\]
...
The formal proof is easy to get since $k-2$ is still even 
and thus, can be divided them in both sides of the initial square $(\Delta_{k-1})^2$
There is a little space left that is filled by half of the other squares.

{\Denis Here we can detail if needed...}
%$(k-2) \times \frac{k-2}{2} = (k-1) \times \frac{k-2}{2} $

\ignore{
{\Arny How do we know about the geometric arrangement of $1^3 + 2^3 + 3^3$?}
{\Denis We simply add $3^3$ to the square: I added two figures to explain in the most difficult case of even $i$...}
}
\begin{figure}[ht]
\begin{center}
