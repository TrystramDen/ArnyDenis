...
\]
{\Denis Her we can refer to the Achille and Tortoise story as this corresponds to the distance done by Achille to reach the tortoise if the initial situation is 1 meter...}
...
{\Denis We can remark here that this result is straightforward by drawing a n+1 by n+1 square composed of a unit square, a n by n square and 2 rectangles 1xn and nx1...}
