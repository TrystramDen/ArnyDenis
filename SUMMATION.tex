...
\paragraph{C. A pictorial solution for $c=2$: Sums of squares}

We now provide a pictorial 
%proof of Proposition~\ref{thm:summing-squares}, i.e., a pictorial 
derivation of the solution (\ref{eq:sum-1-to-nsq}) to the problem of summing the first $n$ perfect squares.
The derivation begins with three depictions of the first $n$ squares and then reorganizes---in a rather Fubini-esque manner---to produce a depiction of the desired sum. 

Throughout, we depict the square of an integer $k$ as a $k \times k$ array of copies of the: The first four perfect squares, namely, $1^2$, $2^2$, $3^2$, and $4^2$, are depicted at the top of each of Figs.~\ref{fig:sumSquares2}, \ref{fig:sumSquares3}, \ref{fig:sumSquares4}, and~\ref{fig:sumSquares5}.  The darkened unit-side squares in these depictions will be used in our pictorial summation process.

The overall strategy of our summation process is depicted schematically in Fig.~\ref{fig:sumSquares1}.
...
\paragraph{D. Semi-pictorial solutions for $c=3$: Sums of cubes}
