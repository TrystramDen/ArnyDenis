...
\left[ \underline{C}_c(n) \ = \ \int_0^{n-1} \ (x+1)^c {\rm d}x \right]
\ \leq \ S_c(n) \ \leq \
\left[ \overline{C}_c(n) \ = \ \int_1^n \ x^c {\rm d}x \right]
\end{equation}
\end{prop}
