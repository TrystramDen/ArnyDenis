...
We now develop a sequence of proofs of Propositions~\ref{thm:sum-finite-geometric-series} and~\ref{thm:sum-infinite-geometric-series}.
...
%Fig.~\ref{fig:riemann-harmonic1} and~\ref{fig:riemann-harmonic2}.
