...
Eq.~(\ref{eq:upper-integral-xc}) into a more convenient form.  We begin by multiplying the expression by $n^{c+1}/n^{c+1} = 1$, which, does not change its value; we then perform some algebraic manipulation.
\begin{eqnarray}
\nonumber
\overline{C}_c(n)
  & = &
