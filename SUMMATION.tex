...
sub-series (\ref{eq:geom-series}), we note the following exploitable fact.
\begin{quote}
This fact can be viewed as one of the ``patterns'' we referred to in
Section~\ref{sec:manifesto} as we mentioned how mathematicians
operate.
\end{quote}
\begin{equation}
