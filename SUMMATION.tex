...
\noindent
Because the aggregate areas of the abutting rectangles lie completely under curve $\overline{C}(x)$, the area under the curve---which we obtain by integrating $\overline{C}$ between appropriate limits---yields an {\em upper bound} on the value of the summation of interest.
...
\caption{The summation $S^{(H)}(n) \ = \ \sum_{i=1}^n \ 1/i$ represented as the aggregate area of a sequence of unit-width rectangles.  The summation is {\em bounded from above} by the area of the leftmost rectangle {\em plus} the area $A$(a) under the continuous curve (a) that connects the upper righthand corners of the rectangles.  In detail, curve (a) begins at the upper righthand corner of the leftmost rectangle; it continues to the upper righthand corner of the rightmost rectangle.  (The figure's resolution makes the righthand end of curve (a) invisible.)  The upper-bounding area is $A(\mbox{a}) = 1 \ + \ \int_1^n \ 1/x dx$.  The summation is {\em bounded from below} by the area $A$(b) under the continuous curve (b) that connects the upper lefthand corners of the rectangles.  In detail, curve (b) begins at the upper lefthand corner of the leftmost rectangle and continues to the upper lefthand corner of the rightmost rectangle.  The lower-bounding area is $A(\mbox{b}) =  \int_0^n \ 1/(x+1) dx$.}
\label{fig:riemann-harmonic}
\end{figure}
The lefthand rectangle {\em plus} curve (a) completely ``cover'' the rectangles; therefore, their combined areas provide an {\em upper bound} on the aggregate area of the rectangles.
Curve (b) lies completely within the rectangles; therefore, the area $A$(b) under the curve is a {\em lower bound} on the aggregate area of the rectangles.
\end{enumerate}
%
...
The curves labeled (a) in Figs.~\ref{fig:riemann-n2} and~\ref{fig:riemann-harmonic} are instances of the stratagem's mandated continuous curve $\overline{C}(x)$.  {\em Note that curve (a) in Fig.~\ref{fig:riemann-harmonic} must be considered to contain the top of the leftmost rectangle in the figure.}

\smallskip

The curves labeled (b) in Figs.~\ref{fig:riemann-n2} and~\ref{fig:riemann-harmonic} are instances of the stratagem's mandated continuous curve $\underline{C}(x)$. 
\end{minipage}
}
