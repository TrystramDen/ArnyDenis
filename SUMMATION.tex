...
Let us be given a right triangle whose height has length $1$ and whose base has length $S$.   The ratio $S/(S-1)$ is equal to the height, call it $b$, of the triangle at distance $1$ from its right angle.
\end{prop}
