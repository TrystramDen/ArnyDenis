...
$\displaystyle \sum_{i=1}^n i^c$, for various values of the fixed
parameter $c$.
%  In
...
\paragraph{\small\sf A. An explicit expression for $S_1(n)$}
...
\paragraph{\small\sf B. An explicit expression for $S_2(n)$}
