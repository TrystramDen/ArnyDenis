...
\addcontentsline{toc}{subsubsection}{-- A fun result: Summing the first
$n$ integers}
...
\noindent {\small\sf Perfect squares and sums of odd integers.}
%
...
\addcontentsline{toc}{subsubsection}{-- A fun result: The $n$th square is
...
\addcontentsline{toc}{subsubsection}{-- A fun result: When is an integer
 divisible by $9$?}

\noindent {\small\sf A result about divisibility.}
%
