...
But sometimes an infinite series does {\em not} have a finite sum.  This is true, for instance, of the well-known {\it harmonic} series \index{harmonic series}
\begin{equation}
...
Now that we know---{\em and understand}---how to derive the value of $S_1(n)$, we can finally evaluate our original series (\ref{eq:arith-seq}).  \index{arithmetic series:explicit sum}
...
\medskip\item
Figure~\ref{fig:riemann-harmonic} illustrates our stratagem as it applies to the ten-term version of the {\em harmonic} summation \index{harmonic summation}
