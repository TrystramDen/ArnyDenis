...
in Fig.~\ref{fig:sumCubesEven}.  We must manipulate the overlapped region in the manner
depicted in Fig.~\ref{fig:sumCubesEvenFinal} in order to get a tight packing around the large
square.  Happily, when there is a small overlapping
square region, there is an identically shaped overlapping square empty region
