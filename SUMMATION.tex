...
Sometimes, it is necessary to state a more general problem for solving a simpler one (at least which appears more simple).
\medskip
...
\noindent \textit{Hint.}
Use the old and simple pattern of multiplication tables that we learned in elementary school.
\medskip
...
and use a proof by contradiction.
\medskip
