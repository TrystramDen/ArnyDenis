...
{\Denis This subterfuge will also evidence another incredible property of integers}
\medskip
...
table---the $i$ elements of the $i$th group adds up to $i^3$.
...
$2 \Delta_{i-1} +1$ ($\left( \Delta_{i-1} +1 \right)$th largest odd number) and ending with
$2\Delta_i -1$.
