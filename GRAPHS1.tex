...
of $\g$, namely, $\e_{\fg}$'s two endpoints.  Since the sum of $\g$'s
...
We often use the term {\it neighbor} within the context of {\em directed} graphs also.
If we say that vertices $u$ and $v$ are neighbors in the directed graph $\g$,
