...
\ignore{\Arny Chance for some exercises here}
...
\subsection{The cycle-graph $\cc_n$}
\label{sec:cycle}
...
\subsection{The complete graph, or, clique $\k_n$}
\label{sec:clique}
...
\subsection{Two related networks: the mesh ($\m_{m,n}$) and the torus ($\widetilde{\m}_{m,n}$)}
\label{sec:mesh}
...
\subsection{The (boolean) hypercube network $\q_n$}
\label{sec:hypercube}
...
\subsection{The de Bruijn network $\d_n$}
\label{sec:deBruijn}
