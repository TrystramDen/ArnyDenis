...
The mesh and torus networks are among the simplest instances of graphs that are built from simpler graphs.  In this case, the underlying operation is the {\it direct product}---or, {\it Cartesian product}---of graphs.
...
As specific examples:  {\em Each mesh-graph $\m_{m,n}$ is the direct product of paths}
\[ \m_{m,n} \ = \ \p_{m} \times \p_n \]
{\em and each torus-graph $\widetilde{\m}_{m,n}$ is the direct product of cycles}
