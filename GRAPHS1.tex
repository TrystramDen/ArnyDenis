...
At the end of Chapter~\ref{ch:combinatorics}, there is an exercise that discusses {\it Monge shuffles}, a mathematical device for rearranging cards in a deck.  The main message of that exercise is that Monge shuffles are {\em not} a good approach for shuffling playing cards: they don't even approach the level of randomness that a good game of chance demands.
