...
{\sc Lesson:} Appreciating asymptotic language by not having it available.
...
\begin{prop}
For all $c , n \in \N^+$, there exists a constant $\kappa$ which does not depend on $n$---although it could depend on $c$---such that, for all sufficiently large $n$"
