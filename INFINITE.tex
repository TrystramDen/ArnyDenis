...
{\em Prove that definitions}
(\ref{eq:straight-defn-of-Theta}), (\ref{eq:Theta-via-O}), and (\ref{eq:Theta-via-Omega}) 
{\em provide three logically equivalent definitions of the assertion}
\[  f(x) = \Theta(f_3(x)) \]
