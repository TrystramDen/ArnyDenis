...
The world of the infinite is even more subtle than the preceding examples suggest.  This world hosts myriad {\em paradoxes}---situations that, in the words of the Apple$^{\mbox{\scriptsize{\sc tm}}}$ dictionary, ``combine contradictory features or qualities".
...
Of course, we have already dealt successfully with a number of quite sophisticated topics related to infinity.  To cite just two examples:
\begin{enumerate}
\item
