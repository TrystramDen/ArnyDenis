...
\subsection{Solving Recurrence (\ref{eq:Lin-Recur:basic})} 
...
(\ref{eq:Lin-Recur:basic}), let us begin to ``expand'' the specified
computation by replacing occurrences of $F(\bullet)$ as mandated in
(\ref{eq:Lin-Recur:basic}).
\begin{equation}
...
solution to (\ref{eq:Lin-Recur:basic}).  \qed
\end{proof}


\subsection{Solving Recurrence (\ref{eq:Lin-Recur:general})} 
