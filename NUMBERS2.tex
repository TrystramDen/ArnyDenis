...
\begin{center}
	\includegraphics[scale=0.2]{FiguresArithmetic/TrianglePascalModulo5init.png}
         \includegraphics[scale=0.2]{FiguresArithmetic/TrianglePascalModulo5.png}
        \caption{Pascal's triangle transformed by using modular arithmetic (here, $p=5$).   (Left) The ``raw" version.  (Right) A version with shading that highlights the reproducible pattern.}
        \label{fig:TriangleModulo5}
\end{center}
\end{figure}
%\begin{figure}[htb]
