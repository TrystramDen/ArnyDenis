...
But for more agents, this is no longer true, we only have:

envy-freeness $\Rightarrow$ proportional fairness.
...
Proving that the reciprocity sufficient condition does not hold is easy by looking at the following counter-example.
\begin{figure}[htb]
\begin{center}
