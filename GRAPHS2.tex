...
\item
All of the ``$y$-vertices'' that appear in cycle (\ref{eq:deBruijn-cycle}) differ from $x$ and from each other.
\end{itemize}
}
...
\begin{proof}[Proposition~\ref{thm:deBruin-linegraph}]
...
and $\Lambda(\d_n)$ completes the proof.  \qed-Proposition~\ref{thm:deBruin-linegraph}
\end{proof}
...
This corollary combines with Proposition~\ref{thm:deBruin-linegraph} to complete the proof of 
