...
\index{$3$-Color Theorem for Outerplanar Graphs}
\index{coloring outerplanar graphs!the Three-Color Theorem}
...
\begin{prop}[The $3$-Color Theorem: Outerplanar Graphs]
...
\paragraph{A. On the Four-Color Theorem for planar graphs}
...
\index{$4$-Color Theorem for Planar Graphs}
\index{coloring planar graphs!the Four-Color Theorem}

\begin{theorem}[The $4$-Color Theorem: Planar Graphs]
\label{thm:Four-ColorTheorem}
Every planar graph is $4$-colorable.
\end{theorem}

\index{Four-Color Problem for planar graphs} 
...
We defer proving Proposition~\ref{thm:Euler-Formula} so that we can proceed with our ongoing proof of Lemma~\ref{thm:PlanarGraph-degree5}.  We devote Section~\ref{subsec:validationEulerFormula} to two quite different proofs of Euler's formula.
...
\index{Six-Color Theorem for Planar Graphs}
\index{coloring planar graphs!the Six-Color Theorem}

\begin{prop}[The $6$-Color Theorem: Planar Graphs]
...
\index{Five-Color Theorem for Planar Graphs}
\index{coloring planar graphs!the Five-Color Theorem}

\begin{prop}[The $5$-Color Theorem: Planar Graphs]
\label{thm:5colors}
