...
We defer proving Proposition~\ref{thm:Euler-Formula} so that we can proceed with our ongoing proof 
of Lemma~\ref{thm:PlanarGraph-degree5}.  
...
Fig.~\ref{fig:K5andK3by3} provides two examples of what is a maximally connected graph.
We challenge the reader to add any more edge without crossing to the planar drawings.
the dotted lines show the missing edges. 

\begin{figure}[hbt]
\begin{center}
       \includegraphics[scale=0.5]{FiguresGraph/K5andK3by3}
       \caption{Maximal planar representations of $\k_5$ (left) and $\k_{3,3}$ (right).}
