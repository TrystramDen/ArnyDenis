...
\medskip\item
$\oplus$ {\bf The Monge shuffle: a mathematical party trick}
...
The following card manipulation is associated with the 18-19th century French mathematician Gaspard Monge.  We employ it as a vehicle for honing your skills in detecting combinatorial patterns.  Others have used it as a party trick.
...
\begin{figure}[h]
\begin{center}
        \includegraphics[scale=0.4]{FiguresArithmetic/suffleMonge}
        \caption{The Monge shufflehuffle for $8$ cards ($n=4$).}
...
(1 & 2 & 3 & 4 & 5 & 6 & 7 & 8) & \rightarrow & (1 & 2 & 3 & 4) & (5 & 6 & 7 & 8) \\
 & & & & & & & & \swarrow & & & & & & & & \\
(1 & 5 & 2 & 6 & 3 & 7 & 4 & 8) & \rightarrow & (1 & 5 & 2 & 6) & (3 & 7 & 4 & 8) \\
 & & & & & & & & \swarrow & & & & & & & & \\
(1 & 3 & 5 & 7 & 2 & 4 & 6 & 8) &  \rightarrow& (1 & 3 & 5 & 7) & (2 & 4 & 6 & 8) \\
 & & & & & & & & \swarrow & & & & & & & & \\
...
\end{array}
\]
So, this does not look too random!  After {\em three} (which, ``coincidentally" equals $n-1$) cut-then-merge steps, the deck has been replicated in its original order!
