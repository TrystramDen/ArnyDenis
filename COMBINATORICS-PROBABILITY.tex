...
Arbuthnot's curiosity, so the story goes, was piqued by a popular belief of the period that more boys are born than girls.  In an effort to assess this belief, Arbuthnot studied an archive that he had access to, which reported on births in London in the $82$-year period 1629--1710.  As reported in his paper
...
An operationally sound answer to the Arbuthnot-Laplace question can be gleaned from a second probability-related theorem, which is known as the {\it Law of Large Numbers}, or, {\it le Loi des grands nombres}.  The significance of the {\it Law} is commensurate with that of the Central Limit Theorem; in fact, the two results are linked by the formal reasoning that underlies both.  As with the Theorem, we state the Law only semi-formally, because it too invokes rather advanced mathematical concepts.

\bigskip

\noindent \fbox{
\begin{minipage}{0.96\textwidth}
For those readers who would like to get a sense of the sweeping Law of Large Numbers, we provide the following annotated semi-formal statement, of course without proof.
