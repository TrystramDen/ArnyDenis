...
\item[{\sf Commentary:}]
Note that we do not demand any uniformity among the $X_i$ other than that they all come from the same distribution.  Since these variables represent outcomes of distinct trials from the same experiment, this demand is satisfied automatically.
