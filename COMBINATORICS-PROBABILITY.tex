...
\[
\begin{array}{lll}
f(a) = a+1 \bmod 3 &: &(0 \rightarrow 1),  (1 \rightarrow 2), (2 \rightarrow 0) \\
\mbox{and} &  & \\
g(a) = a-1 \bmod 3 &: & (0 \rightarrow 2),  (1 \rightarrow 0), (2 \rightarrow 1)
\end{array}
\]
In fact, how many derangements does an arbitrary $n$-element set $A$ have?  We derive some 
preliminary information about this question---but we basically leave further study of this
non-elementary topic to the reader.

\medskip

Let us denote by $d(n)$ the number of derangements of an arbitrary $n$-element set $A$.
...
$d(1) = 0$: \ \ the unique bijection consists only of a fixed point. 

\item
$n=2$:

$d(2) = 1$: \ \ there are two bijections, the identity (two fixed points) and the swap (a derangement)
...
In any derangement, the first element of $A$, call it $a$, must map to some $b \neq a$.  There
