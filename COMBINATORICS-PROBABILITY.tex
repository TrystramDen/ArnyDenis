...
{\em converges to the normal distribution with mean $\mu$ and variance $\sigma^2$.}
\end{description}
\end{minipage}
}
...
Pointers to an answer to The Arbuthnot-Laplace question can be gleaned from a second probabilistic theorem, whose significance is commensurate with that of the Central Limit Theorem.  In fact, the formal reasoning that yields the upcoming {\it Law of Large Numbers} is quite similar to the formal underpinnings of the Central Limit Theorem.
