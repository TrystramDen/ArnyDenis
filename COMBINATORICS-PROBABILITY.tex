...
Of course, we realistically do not expect to see this average roll by roll---that is why we need higher moments to truly understand the behavior of experiments!  But the Law guarantees that as we roll the dice over and over, we should observe the sequence of average roll-values tend to $3.5$.

\item
Let consider a barrel that contains both white and black balls.  We consider two variants of this situation: (1) when we know the relative numbers of black and white balls and (2) when we do not have this knowledge. 
