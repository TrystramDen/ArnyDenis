...
\subsubsection{Normal distributions and the {\it Central Limit Theorem}} 
...
Pointers to an answer to The Arbuthnot-Laplace question can be gleaned from a second probabilistic theorem, which is known as the {\it Law of Large Numbers}, or, {\it le Loi des grands nombres}.  The significance of the {\it Law} is commensurate with that of the Central Limit Theorem; if fact, the two results are linked by the formal reasoning that underlies both.
