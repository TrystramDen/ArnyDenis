...
\begin{prop}
Let $p$ be an odd prime, and let $n = {1 \over 2} (p-1)$.  Let us begin with a deck of $2n$ distinct cards and perform the Monge shuffle on the deck.  After a number of cut-then-merge steps that divides $p-1$, the Monge shuffle replicates the initial deck.
\end{prop}
\smallskip
