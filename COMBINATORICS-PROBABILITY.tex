...
\label{sec:statistics}
 ...
 \noindent \fbox{
 \begin{minipage}{0.95\textwidth}
The numbers have been generated, e.g., by measuring the results of some process or by
observing some natural or artificial phenomenon.   An example of the former situation is a
process that provides an empirical estimate of the value of the gravitational force via
repeatedly dropping a ball of known mass and timing the moment of its impact with the earth.
An example of the latter situation is recording over fixed periods the percentage of births in 
which the newborn has a specific gender.
 \end{minipage}
 }
...
in a manner that will give a reliable summary of the import of the data.  The field of statistics provides well-studied approaches to this important challenge.
 ...
 a single number: mode, median, mean (expectation -- a probabiity-weighted average)
