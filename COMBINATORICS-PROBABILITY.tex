...
\medskip
\item
{\bf The Monge shuffle: a mathematical party trick}
...
\end{array}
\]
So, this does not look too random!  After {\em three} (which, ``coincidentally" equals $n-1$) cut-then-merge steps, the deck is reversed---and after {\em six} (which, ``coincidentally" equals $2(n-1)$) steps, the deck has been replicated in its original order!
