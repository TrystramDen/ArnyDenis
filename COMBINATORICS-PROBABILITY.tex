...
We now provide a more sophisticated merge procedure, which yields a sophisticated variant of the Monge shuffle.  In this variant, we rearrange the $2n$-card deck directly, from the middle outward, as suggested by the following illustration for the case $n=4$:
...
The first card of the Original, $2n$-card, deck is placed in position $n+1$ of the Shuffled deck.

The second card of the Original deck is placed in position $n$ of the Shuffled deck.

The third card of the Original deck is placed in position $n+2$ of the Shuffled deck.

The fourth card of the Original deck is placed in position $n-1$ of the Shuffled deck.

\ldots and so on, until the Original deck is empty.
