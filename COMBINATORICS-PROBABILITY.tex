...
\begin{itemize}
\item
Our definition of the (discrete) probability, or, likelihood, of an event is in terms of a ratio:
\[ 
\frac{\mbox{number of targeted events}}{\mbox{number of possible events}}
\]
This approach has technical consequences which influence our coverage of the topic.
  \begin{itemize}
  \item
