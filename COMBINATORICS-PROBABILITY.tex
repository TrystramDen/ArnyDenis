...
With this introduction, we now embark on our introduction to statistics.

 
\subsection{Summarization by a Single Number}
\label{sec:single-statistic}
 
Summarize a set of numbers by a small set of numbers
 
Let us be given an $n$-element set $S$ with an associates frequency function $f_S$.  The
following definitions are idealizations in the sense that they may specify more than one
element of $S$.
