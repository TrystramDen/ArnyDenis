...
(almost) completely by designing your counter to implement the slightly
misnamed {\it carry-free addition}.  The carry-free adders we sketch
now engender a bounded---i.e., $O(1)$---delay between button-pushes,
no matter how long you keep pushing the button.
