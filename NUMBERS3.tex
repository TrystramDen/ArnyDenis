...
In order to achieve ``carry-free'' addition, we have to redesign your
...
\index{redundant number systems} which is often known also as a {\it
  signed-digit number system}.  \index{igned-digit number system}
...
\index{base-$b$ redundant number system} \index{radix-$b$ redundant
  number system} has the following set of digits.\footnote{($a$)
