...
\chapter{NUMBERS III: \\
Operational Number Representations, and Their Consequences}
\label{ch:numerals}
...
{\Denis Attention, correct the formula above, $b^2$ is missing}
...
\section{$\F$ and $\R$ are uncountable, hence, ``bigger than'' $\Z$ and $\Q$}
...
{\Arny The version relating to $\R$ appears in NUMBER3-backup.tex}
