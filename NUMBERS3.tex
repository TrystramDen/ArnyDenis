...
\hspace*{.75in}William Shakespeare, {\it Romeo and Juliet}
\end{quote}
...
This section completes the topic of the cardinalities of infinite sets
which we began in Section~\ref{sec:compare-sets-via-card}.  We
discussed {\em countable} sets in that section; we turn here to the
complementary topic of {\em uncountable} sets.
