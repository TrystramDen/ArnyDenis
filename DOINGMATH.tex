...
\noindent
As in paragraph {\small\sf A}, there are multiple plausible answers to
...
Zeno of Elea, \index{Zeno of Elea} \index{Zeno!Zeno's paradox} in his
celebrated {\it Paradox of Achilles and the Tortoise}, presented a
...
The resolution of the apparent paradox resides in the notion of {\em
  infinitesimals}. \index{infinitesimals} While familiar today to
anyone who has studied differential calculus, the notion of
infinitesimal actually dates only to the 17th century.  Underlying the
invention is one of the great real-life mysteries of all time: Who
invented/discovered infinitesimals.  The parties to this dispute were
the German mathematician Gottfried Leibniz \cite{Leibniz}
...
integers as the room numbers in the a finite-capacity hotel---has a
largest number, while an infinite set of positive integers does not
have a largest number.
...
only via the devlopment of sophisticated, advanced, mathematical
machinery.

\paragraph{\small\sf A.  G\"{o}del's paradox: Self-referentiality in langauage}

Let us focus on the following utterance, which we call ``Sentence $S$''.

{\em The sentence you are reading at this moment is false.}
...
philosopher/logician Bertrand Russell \index{Russell, Bertrand}
