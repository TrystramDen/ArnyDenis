...
\subsection{Classical vs.~modern proof methods}
...
of ``antiquity'' is a vibrant system of thought that
\begin{itemize}
\item
...
structural induction, contradiction, counting, \ldots) mixed and
matched throughout an analysis

\item
invokes a highly tested computer program to check mind-numbing
proliferations of clerically verifiable facts.
\end{itemize}

**HERE
logical frameworks of those days have persisted to the present day,
despite the emergence of real-life-oriented fields---such as computer
science---that cannot advance very far without at least informal
analogues of the now-archaic formal systems, and despite the
development of quite powerful automatic systems to aid in the
development of proofs.

This resistance to modernized and humanized---but no less
rigorous---proof systems and methods likely explains the resistance of
professionals and students alike to assimilating formal methods into
their lives.  In response to such resistance, courses in mathematics
have often abjured {\em understanding} in favor of often-shallow rote
knowledge.  While the former goal would enable every computing
professional to develop mathematics as relevant to daily endeavors,
the latter reality has left the computing world with systems that are
largely at best partially understood and only vaguely analyzed.  And,
the reality has removed many of the incentives for the development of
a new mathematics that is part of the toolkit of every computing
practitioner.

Regarding the mathematics that is relevant to computing, one often
finds that even the gifted student who masters the mathematical
material in a comprehensive textbook are unable to adapt existing
proofs to novel situations.  Not only can they not intuit how to start
an original proof, they are often unable to analyze cogently what
needs to be proved, i.e., to state informally what they ultimately
would have to formalize. 

We want to begin to change this situation with this book.  We want to
enable students to understand existing proofs about computing-related
systems and concepts and to empower them to develop new new proofs as
existing ones are found inadequate to the purpose.  We want to supply
the student with a panoply of viewpoints and representations of both
mathematical and real-life concepts that will enable the student to
develop mathematical intuition about systems and phenomena that are
largely mathematical at their core.

\subsection{Unconventional approaches to proofs}
\label{sec:unconventional-proofs}
