...
\paragraph{\small\sf The average length of a carry in a binary counter}
...
Insert solving the second degree equation...
...
and then, choosing the other one among the $k-1$ remaining ones before $k$, which can be mathematically written as:
...
\caption{Function $g$ is a Big O of $f$ and $h$ is a Big Omega of $f$.}
