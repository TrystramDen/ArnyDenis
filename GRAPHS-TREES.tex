...
Select the leftmost neighbor, $v$, of $u$ that remains in the layout.
  \begin{itemize}
  \item
If we succeed in finding such a $v$, then add edge $\{u,v\}$ to
...
\begin{itemize}
\item
The first two graphs, the {\it cycle-graph} of paragraph~\ref{sec:cycle}
and the {\it complete graph} of paragraph~\ref{sec:clique} were selected
...
The remaining graphs, the {\it mesh and torus networks}\footnote{These
  ...
  because they share so many important properties.}~of paragraph~\ref{sec:mesh}, 
  the {\it hypercube network} of paragraph~\ref{sec:hypercube},
and the {\it de Bruijn network} of paragraph~\ref{sec:deBruijn}, were
