...
Theorem~\ref{thm:Four-ColorTheorem}, but we shall now present the
six-color and five-color analogues of the theorem.  The redundancy in
our presentation is motivated by the fact that the six-color result is
so close to its outerplanar-graph cousin,
Proposition~\ref{thm:OP-3-colorability}.
