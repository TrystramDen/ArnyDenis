...
In contrast to maximal matchings, there exist myriad simple that do
not admit any perfect matching.  We leave to the reader the challenge
...
weighted graph can be obtained in polynomial time (using the Hungarian
