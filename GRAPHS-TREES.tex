...
An edge-exhausting cycle in a graph $\g$ is called an {\it Eulerian
  cycle},\index{graphs!Eulerian cycle} \index{Eulerian cycle} or {\it
  Eulerian circuit}, \index{graphs!Eulerian circuit} \index{Eulerian
  circuit} yet another concept named for the Swiss mathematician
Leonhard Euler \index{Euler, Leonhard} who is credited with inventing
the concept---in addition to the entire field of graph theory.  (An
edge-exhausting path in $\g$ is named analogously.)  When one views an
Eulerian cycle as a ``map'' for traversing a graph, one often calls
the cycle an {\it Eulerian tour}.  \index{graphs!Eulerian tour}
\index{Eulerian tour} Traditionally, a graph that admits an Eulerian
cycle is said to be a {\it Eulerian graph}. \index{graphs!Eulerian}
\index{Eulerian graph}

Dually: A node-exhausting cycle in a graph $\g$ is called a {\it
  Hamiltonian cycle}, \index{graphs!Hamiltonian cycle}
\index{Hamiltonian cycle} or {\it Hamiltonian circuit},
...
concept in the mid-19th century.  (A node-exhausting path in $\g$ is
named analogously.)  When one views a Hamiltonian cycle as a ``map''
for traversing a graph, one often calls the cycle a {\it Hamiltonian
  tour}.  \index{graphs!Hamiltonian tour} \index{Hamiltonian tour}
Traditionally, a graph that admits a Hamiltonian cycle is said to be a
{\it Hamiltonian graph}. \index{graphs!Hamiltonian} \index{Hamiltonian
  graph}
...
has an {\it Eulerian cycle}---and the allied problem of finding such a
