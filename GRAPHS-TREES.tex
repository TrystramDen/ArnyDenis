...
string as a substrings.  One can prove that no string shorter than
$2^n +n-1$ will work.  {\Arny (A GOOD EXERCISE)}  Here are two
examples.
\[
\begin{array}{ll}
00, \ 01, \ 10, \ 11
...
000     101  101     111
     100        110
 \cite{AnnexsteinBR90} \cite{Ullman84}


%\langle 1, \ n \rangle, \ \langle 2, \ n \rangle
