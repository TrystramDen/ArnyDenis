...
\bibitem{Bernstein05}
F.~Bernstein (1905): Untersuchungen aus der Mengenlehre.
{\it Math.~Ann.~61}, 117--155.
...
space.  {\it 18th IEEE Symp.~on Foundations of Computer Science (FOCS)}, 147--161.
...
{\it Rom.~Acc.~L.~Rend.~(5), 16(1)}, pp.~608â614.  In {\it zbMATH 38.0343.02}.  Reprinted in G.~Fubini (1958): {\it Opere scelte, 2}, Cremonese, pp. 243--249.
...
\bibitem{Hadamard}
J.~Hadamard (1896):
Sur la distribution des z\'{e}ros de la fonction $\zeta(s)$ et ses cons\'{e}quences arithm\'{e}tiques.
...
{\it Proc.~USSR Academy of Sciences, 145}, 293--294.  (Translated in {\it Physics-Doklady, 7} (1963) 595?596.)
...
%{\it SIAM J.~Applied Mathematics 36}(2), 177-â189.
...
\bibitem{Newton}
I.~Newton (1687): {\it Philosophia Naturalis Principia Mathematica}
...
%{\it IEEE Trans.~Computers 43}(8), 880-â891.
...
\bibitem{Shinahr74}
I.~Shinahr (1974): Two- and three-dimensional firing-squad synchronization problems.  {\it Inform. and Control 24}, 163-â180.
