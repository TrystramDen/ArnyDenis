...
{\it Answer the following questions for each of these sequences.
  \begin{enumerate}
  \item
Is there a choice of positive base integers $a_0, \ a_1$ for which the entire sequence $A$ consists of only odd integers?
  \item
Is there a choice of positive base integers $b_0, \ b_1, \ b_2$ for which the entire sequence $B$ consists of only odd integers?
  \item
Is there a choice of positive base integers $a_0, \ a_1$ for which the entire sequence $A$ alternates between even and odd integers?
  \item
Is there a choice of positive base integers $b_0, \ b_1, \ b_2$ for which the entire sequence $B$  alternates between even and odd integers?
\end{enumerate}
}

\item
{\bf $\oplus$ The rationals ($\Q$) and the integers ($\N$) are equinumerous}
