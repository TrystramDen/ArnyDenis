...
{\em Lesson:} Learn to recognize the influence of numerical properties such as parity within computations
...
It is common in the study of recurrences to encounter summations of the following forms:
\begin{itemize}
\item
...
\end{eqnarray*}
\end{itemize}
Each such recurrence generates an infinite sequence of positive integers, of the following form:
\[ c_0, c_1, c_2, c_3, c_4, \ldots \]
The first couple of numbers are the initial cases of the relevant recurrence; all subsequent numbers arise from the recurrence itself.
...
{\it Prove the following assertions:} 
  \begin{enumerate}
  \item
