...
Proposition~\ref{thm:m-commondivisor-n-q}, then {\sc gcd}$(n, q)$ divides all linear combinations $s n +t q$ of $n$ and $q$, for any integers $s$ and $t$.  In particular, {\sc gcd}$(n, q)$ divides the {\em smallest} such combination. 
