...
{\em Define the following two set-operations from union and set difference:}
  \begin{enumerate}
  \item
The operation {\it intersection} (denoted $S \cap T$) isolates all elements that shared by sets $S$ and $T$.
  \item
The operation {\it symmetric difference} (denoted $S+T$) isolates all elements that belong to precisely one of $S$ and $T$.
  \end{enumerate}
