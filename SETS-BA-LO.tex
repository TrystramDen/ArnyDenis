...
\index{SOP-form expression}, shorthand for {\it sums of products}.  A
 discovery in 1971 by Stephen A.~Cook \index{Cook, Stephen A.}
...
assertion began in 1971 when Stephen A.~Cook \index{Cook, Stephen A.}
published, in \cite{Cook71}, a revolutionary new foundation for the
field of {\it Computational Complexity}. \index{Computational
  Complexity} Cook achieved this goal by adapting
arguments\footnote{These arguments were the legacy of intellectual
  ...
  Theory} \index{Computability Theory} in a way that enabled one to
