...
%{\Denis make the link with the introduction of chapter 11 where we
%present basic operations of sets (intersection, union, etc.)}
...
%{\Denis Attention, change t into u in the following equation}
\[ 
...
{\Denis Attention, we use bar as the negation and not tilda...}
