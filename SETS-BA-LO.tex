...
studies how the {\em truth-values}, {\sc true} or {\sc false}, of
elementary logical expressions combine via operators such as {\sc
  and}, {\sc or}, and {\sc not} to produce a truth-value for complex
logical expressions.
...
within this system by symbolic evaluation rather than the axioms plus
rules of inference that we all found so onerous in high school
geometry.
  \item
Propositional logical expressions are powerful to model certain types
of {\em computations} faithfully enough to serve as a foundation for a
methodology for measuring computationa complexity.
  \end{itemize}
\end{itemize}
