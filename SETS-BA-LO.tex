...
\noindent
As we noted earlier in this chapter, what distinguishes Propositional Logic from more general mathematical logic is the absence of quantifiers ({\sc there exists}, {\sc for all}, etc.).  The objects of Propositional Logic are {\it propositions}: fixed assertions exemplified by\footnote{The third of these propositions was used by Noam Chomsky in his seminal monograph {\it Syntactic Structures} (Mouton Press, 1957, {\it Janua Linguarum} series) to illustrate the independence of ``grammaticalness" from meaning.}
