...
logical system that can reason usng elementary arithmetic propositions
...
semantically complete.  We discusss this fact now.

\bigskip

\noindent{\small\sf B. Propositional Logic: {\em free} and {\em complete}}.
\index{logical system!completeness}
...
\noindent{\small\sf C. The Propositional logical connectives via truth tables}.
...
logical expressions into the truth values {\sc true} and {\sc
  false}---often denoted $1$ or $0$, respectively.  The following
tables reproduce the definitions of Subsection~A within this
...
is manifest in the following \index{meta-theorem}
...
is discussed and proved in \cite{Rosser53}, a source that explains
