...
\noindent{\it The Propositional logical connectives via truth tables}.
...
logical expressions into the truth values {\sc true}, or $1$, and
{\sc false}, or $0$.  The following tables reproduce the
