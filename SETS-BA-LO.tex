...
Satisfiability problems focus on logical expressions that are {\it
  conjuncts of disjuncts}.  In the lingo of the ``in-crowd'', these
expressions are said to be in {\it POS} form, \index{POS-form expression} 
or {\it product of sums}.  More formally, the expressions are {\it
  conjuncts of disjuncts}, i.e., {\it logical products of logical
  sums}.  Until 1971, POS expressions were viewed as nothing more than
the duals of the somewhat more common {\it SOP}-form expressions,
...
\paragraph{\small\sf A. The general satisfiability problem SAT}
