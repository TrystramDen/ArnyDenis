...
{\sc Lesson:} Exploit these connections
...
\item
Based on your answers for the first and second and third a numbers, how many ways can you choose {\em the first two numbers}
\end{itemize}
  \item
