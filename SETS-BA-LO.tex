...
\noindent {\it The objects of the algebra}.
...
\noindent {\it Logical connectives: the operations of the algebra}.
...
\noindent {\small\sf The {\em unary} logical connective}
\begin{itemize}
\item
\underline{{\small\sf not} ($\sim$)}
\index{logical operation!{\sc not} ($\sim$)}
The operation {\small\sf not} is the logical analogue of the
set-theoretic operation {\em complementation}.

Because the notation ``{\small\sf not}'' makes logical expressions
long and cumbersome, two shorthand notations for ``{\small\sf not}
$P$'' have evolved:
  \begin{itemize}
  \item
...
\noindent {\small\sf The {\em binary} logical connectives}
\begin{itemize}
\item
