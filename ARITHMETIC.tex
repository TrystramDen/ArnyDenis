...
valued letter augments the value of the numeral (e.g., CCL $=250$, XVI
...
systems such as Hebrew's, which incorporates ideas used by the ancient
Egyptians, Phoenicians, and Greeks.  Hebrew assigns the following
...
often allow repeated letter instances or using auxiliary words, such
as ``thousands''.


Alphabet-based systems for creating numerals are more valuable than
...
alphabet-based systems will recognize what is possibly the biggest
drawback of such systems: It is {\em exceedingly difficult} to do any
but the most trivial arithmetic using such systems' numerals.  Two
simple examples using Roman numerals will make our case:
\begin{itemize}
\item
...
assign the Roman-numeral problem as a first assignment.
\item
