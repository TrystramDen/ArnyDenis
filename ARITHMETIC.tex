...
We use  the set $\Z \times \Z$ as the exemplar of these three sets of
...
\noindent
{\em (ordered) tuples of integers}\index{tuples of integers}\index{integer!tuples}\index{tuples of integers!via ordered pairs}\index{integer!tuples!via ordered pairs}
...
\noindent
{\em strings of integers}\index{integer!string}\index{string of integers}\index{integer!string!via ordered pairs}\index{string of integers!via ordered pairs}
...
\noindent
{\em binary trees}\index{integer!binary tree!via ordered pairs}\index{binary tree of integers!via ordered pairs}
...
and $\N^+$---in the eyes of the readers.  With that process hopefully
...
\noindent
{\em What does it mean to ``encode''\index{encode} one class of
...
\noindent
{\em We now develop {\em easily computed} bijections between any of
  the sets $\Z \times \Z$, $\N \times \N$, or $\N^+ \times \N^+$ and
  the set $\N^+$ of positive integers.  We thereby exhibit easily
  computed mechanisms for \underline{encoding} ordered pairs of
  integers---hence, also, strings and binary trees of integers---as
  single integers.  }
