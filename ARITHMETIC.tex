...
\paragraph{\sf A. Integers and their number line}
...
\paragraph{\sf B. Prime numbers}\index{number!prime numbers}
...
\paragraph{\sf A. Inventing the rational numbers}
...
\paragraph{\sf B. The rationals as ordered pairs of integers}
...
\paragraph{\sf C. Comparing the rationals with the integers}
...
\paragraph{\sf A. Invemting the real numbers}
...
\paragraph{\sf B. The real numbers via their numerals}
...
\paragraph{\sf C. Not all real numbers are rational}
...
\paragraph{\sf A. The basics of the complex numbers}
...
\paragraph{\sf B. Pairing functions: ordering $\C$ and $\N \times \N$}
...
\noindent {\underline{\bf Procedure}} {\sf PF-Constructor}($\a$) \\
...
designed via Procedure {\sf PF-Constructor} is a bijection.
\end{prop}

\proof{(Sketch) Step 1 of Procedure {\sf PF-Constructor}
...
We have noted how to use Procedure {\sf PF-Constructor} to
...
designed via Procedure {\sf APF-Constructor}, hence is of the
...
\paragraph{\sf A. Positional number systems}
...
\paragraph{\sf B. Scientific notation}
...
\noindent {\sf Two special integers}
%
...
\noindent {\sf  The operations of arithmetic}\index{arithmetic!basic operations}
%
...
\noindent {\sf A. Negating and reciprocating numbers.}
...
\noindent {\sf B. Floors, ceilings, magnitudes.}
...
\noindent {\sf C. Factorials (of nonnegative integers).}
...
\paragraph{\sf A. Addition and Subtraction.}
...
\noindent {\sf B. Multiplication and Division}.
...
\paragraph{\sf C. Binomial coefficients and Pascal's triangle}
...
\noindent {\sf A. The commutative law.}
...
\noindent {\sf B. The associative law}
...
\noindent  {\sf C. The distributive law.}
...
\paragraph{\sf A. Exponential functions}.\index{Exponential functions}
%
...
\paragraph{\sf B. Logarithmic functions}.\index{Logarithmic
  functions}
%
...
{\sf Absolute values, or, magnitudes}
%
