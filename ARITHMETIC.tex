...
\chapter{Arithmetic: Putting Number to Work}
\label{ch:arithmetic}
...
Section~\ref{sec:exponential+logarithm}; we just define the operation
here.
...
We shall note in Section~\ref{sec:exponential+logarithm} that most of
the main properties of this operation can be inferred from properties
of the operation of exponentiation.
...
result, one recognizes that the material in Appendix
Chapters~\ref{ch:Reals-uncountable}
and~\ref{Appendix:building-pairing-functions}---both of
