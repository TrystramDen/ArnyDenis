...
Previous chapters have given us the simple objects that we use to
count and measure and aggregate.  The current chapter is devoted to
expounding the rules for manipulating these objects and to developing
the tools for creating complex objects out of the simple ones.
...
\subsection{$\oplus$ The General Unsolvability of the Problem}
