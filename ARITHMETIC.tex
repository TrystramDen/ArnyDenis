...
\subsection{Norms Metrics and for Tuple-Spaces}

By the 1950s, computers had become sophisticated enough to handle
structured data  computer users became sophisticated enough to think in terms
of structured models.  Thus, during the 1960s, one began to see
{\it tuple-spaces} \index{ , it took virtually no time until application
designers abandoned the simple linear structures of the 
