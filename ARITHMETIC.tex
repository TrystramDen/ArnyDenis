...
The operations of multiplication and division are said to be {\em
  inverse operations}\index{arithmetic!integers!multiplicative inverse}
...
In summation, we now know about powers that are integral or fractional,
...
\noindent ($b$)
{\Denis We have another proof in the chapter Recurrence.
I suggest to gather all properties at the same place (which one?)}
