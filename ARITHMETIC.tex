...
\end{eqnarray}
Clearly, $P^{(3)}(z) = 0$ precisely when
\[ (z^3)^2 \ + \ F (z^3) \ - \ \frac{E^3}{27} \ = \ 0 \]
If we view this equation as a quadratic in the ``variable'' $z^3$ (we
kept $z^3$ within parentheses to facilitate this view), then the
quadratic formula (\ref{eq:generic-quadratic-4}) allows us to solve
for $z^3$, as follows.  **HERE
