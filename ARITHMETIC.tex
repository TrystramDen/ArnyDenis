...
Consider the generic quadratic---i.e., degree-$2$---polynomial
\index{Polynomial!quadratic!generic}
...
\ a \in \R \setminus \{0\}
\end{equation}
We use a widely applicable strategy to {\it solve}
\index{polynomial!solving a polynomial} $P(x)$, i.e., to discover the
two roots promised by Theorem~\ref{thm:fund-thm-algebra}.
