...
$GCD(a,b)$ is equal to the smallest positive linear combination of $a$
and $b$.\footnote{This result is also known as B\'{e}zout's identity.}
...
\[ \approx \approx \approx \approx \approx \approx \approx \approx \approx \approx \]\index{Proof by contradiction}
