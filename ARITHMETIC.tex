...
The array in Fig.~\ref{fig:pascal-triangle} is usually attributed to Blaise
Pascal in the West, with a date in the 17th century.  In fact, the
array appears in {\it Siyuan Yujian} \cite{Zhu-1303},
a Chinese book from the early 14th century; the array is there attributed to Jia Xian in the 11th century.  \index{Zhu Shijie} \index{Jia Xian}
\end{minipage} }
