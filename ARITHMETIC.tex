...
in a sense that can be made precise but is beyond the scope of this
text.  This problem is quite tractable, though, for degree-$2$---{\it
...
\paragraph{\small\sf B. Solving a general quadratic polynomial}
