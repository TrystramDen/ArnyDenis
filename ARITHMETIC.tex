...
This section introduces the fundamentals of two important
operations, which are functional inverses of each other, in
the sense of equation (\ref{eq:functional-inverse}).
