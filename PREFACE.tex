...
The number of nontraditional students seeking technical education is growing, and the ways in which their nontraditional goals and backgrounds manifest themselves is increasing.  We have striven to keep this diversity in mind while writing this text.  First, we have included a broad range of material, in both subject and level.  Next, we have tried throughout to expound on the fundamentals of mathematical ideas, unadorned by superficial (from a mathematical perspective) details that arise in specific applications.   Finally, we have addressed certain basic notions (e.g., ``number") in layers of increasing detail, as we guide the reader along a journey from student to apprentice.
