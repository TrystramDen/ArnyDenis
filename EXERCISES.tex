...
We introduced two shuffles of a deck of $2n$ distinct cards.  Both techniques cut the deck in the middle, creating two $n$-card decks, and then merge the $n$-card decks to again obtain a single $2n$-card deck.  The techniques differ in their merging techniques.
  \begin{itemize}
  \item 
The {\em riffle} shuffle alternates the ``top" cards from the righthand and lefthand $n$-card subdecks. 
