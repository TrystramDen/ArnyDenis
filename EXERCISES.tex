...
{\Arny We could use this as a significant application of the Fundamental Theorem of Arithmetic --- the theorem is Therorem~\ref{thm:Fund-Thm-Arith};
It appears in Section~\ref{sec:Fund-Thm-Arith}.}
