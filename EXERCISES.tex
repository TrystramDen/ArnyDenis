...
I do not believe that an adequate solution even has to address the issue of characterizing the worst case, because the easily attainable case is so easy.
...
This gives us two easy recurrences which the student should be able to solve.
}
