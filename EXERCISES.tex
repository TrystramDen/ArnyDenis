...
This should be removed since it has been put as an appendix...
...
\begin{prop}
\label{thm:deBruin-linegraph-EX}
For all $n \in \N^+$,
...
combine with Proposition~\ref{thm:deBruin-linegraph-EX} to complete the
