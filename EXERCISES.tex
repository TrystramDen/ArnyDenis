...
S_2(n+1) & = &  1 \ + \sum_{i=2}^{n+1} i^2 \\
 ...
 & = & 1 \ + \ S_2(n) \ + \ 2.S_1(n) \ + n
\end{eqnarray*} 
The term $S_2(n)$ disappears while coming back to the two expressions of $S_2(n+1)$:
\begin{eqnarray*}
...
\[ 
\begin{array}{ll}
S^{(H)}   & = \ (1)  +  \left( {1 \over 2} + {1 \over 3} \right)  +  \left( {1 \over 4} + {1 \over 5} + {1 \over 6}+ {1 \over 7} \right)  +  \left( {1 \over 8} + {1 \over 9} + {1 \over 10}+ {1 \over 11}  +{1 \over 12} + {1 \over 13} + {1 \over 14}+ {1 \over 15} \right) \ +\cdots
\end{array} \]
}

Grouping the terms as before, the sum within each group is between $\frac{1}{2}$ and $1$:
\[ 
\begin{array}{ll}
{1 \over 2} + {1 \over 3}  & < 1 \\
{1 \over 4} + {1 \over 5} + {1 \over 6}+ {1 \over 7}  & < 1 \\
{1 \over 8} + {1 \over 9} + {1 \over 10}+ {1 \over 11}  +{1 \over 12} + {1 \over 13} + {1 \over 14}+ {1 \over 15} & < 1 \\
\cdots
\end{array} 
\]
Thus, 
...
{\em Propose an alternative analysis by gathering the terms 3 by 3}
