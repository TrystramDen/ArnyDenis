...
\end{center}
\end{figure}
As the three sub-triangles are identical, the area of the central reversed triangle is $\frac{1}{3}$ of the area of the layer. 
...
one sees that the area of the grey sub-triangle of Fig.~\ref{Fig:Sum1over4cascade}(left) is $1/4$.  Because the grey triangle occupies one-third of the area of each layer of Fig.~\ref{Fig:Sum1over4cascade}(right), the aggregate area of the grey sub-triangles is $1/3$.  
One can now apply Fubini's principle to evaluate the sum $\sum_{k \geq 1} \ 4^{-k}$.
\end{itemize}
